// MAX Number Checker API — browser/JavaScript example.
// Workflow: submit a file of E.164 numbers -> poll status -> download results.
// Docs: https://docs.checknumber.ai/max-checker
//
...
const TASK_TYPE = "max"; // max | max_full
...
//   const url = await checkMAX(e.target.files[0]);
